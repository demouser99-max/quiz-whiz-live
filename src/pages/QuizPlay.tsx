...
const QuizPlay = () => {
  ...
  return (
    <div className="min-h-screen bg-background bg-particles px-4 py-6">
      <div className="mx-auto w-full max-w-6xl grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-6">
        {/* Main quiz column */}
        ...
        {/* Live leaderboard sidebar — auto-refreshes every 1s from backend */}
        <aside className="lg:sticky lg:top-6 lg:self-start order-first lg:order-last">
          <div className="glass-strong rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-display font-semibold text-sm text-foreground">Live Leaderboard</h3>
